...
* `height_difference_min = height_difference_max / 2` (maximum bundles for 0.5 day)
...
* the data source node has a time window of 12 hours to connect to peers to continue syncing
